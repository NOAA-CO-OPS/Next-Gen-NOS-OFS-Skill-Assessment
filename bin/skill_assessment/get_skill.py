...
from model_processing import get_forecast_hours, get_node_ofs, model_properties
from obs_retrieval import get_station_observations, station_ctl_file_extract, utils
from skill_assessment import format_paired_one_d, make_skill_maps, metrics_paired_one_d
 ...
 respective data and creates the paired (.int) datasets and skill table.
    ...
    if (prop.horizonskill == True and
        ...
        try:
            ...
            logger.error("Exception caught in get_forecast_hours after "
