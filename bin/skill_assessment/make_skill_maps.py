...
This script makes plotly express maps of the output skill tables. Each obs
station is mapped, and each obs station marker is colored coded by RMSE between
obs and model. Clicking on an obs station shows all skill statistics.
"""
