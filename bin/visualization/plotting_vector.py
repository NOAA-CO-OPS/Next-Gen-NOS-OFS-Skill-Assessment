...
#    figheight = 900
    ...
    fig.write_html(
        ...
        f'currents_timeseries_{naming_ws}_{prop.ofsfiletype}.html',
    )
...
def oned_vector_plot2b(fig_info_data,name_var,station_id,node,prop,logger):
    ...
    fig.write_html(
        r'' + f'{prop.visuals_1d_station_path}/{prop.ofs}_{station_id[0]}_'
        f'currents_rose_{naming_ws}_{prop.ofsfiletype}.html',
    )
...
def oned_vector_plot3(now_fores_paired,name_var,station_id,node,prop,logger):
    ...
    fig.write_html(
        r'' + f'{prop.visuals_1d_station_path}/{prop.ofs}_{station_id[0]}_'
        f'currents_stick_{naming_ws}_{prop.ofsfiletype}.html',
    )


def oned_vector_diff_plot3(now_fores_paired, name_var, station_id,
                           node,prop,logger):
    '''This function creates the standard vector time series plots'''
    # Choose color & style for observation lines and marker fill.
    ncolors = len(prop.whichcasts) + 1
    ...
    fig.write_html(
        r'' + f'{prop.visuals_1d_station_path}/{prop.ofs}_{station_id[0]}_'
        f'currents_diff_{naming_ws}_{prop.ofsfiletype}.html',
    )
