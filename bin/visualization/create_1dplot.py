...
from model_processing import (model_properties, get_fcst_cycle,
                              parse_ofs_ctlfile, check_model_files)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-d", "--Datum", required=True, help="datum: 'MHW', \
        'MLW', 'MLLW', 'NAVD88', 'IGLD85','LWD'")
    parser.add_argument(
