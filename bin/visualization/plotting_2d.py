...
from .create_2dplot import list_of_json_files, get_intersection, json_to_numpy, metrics_two_d, write_2dskill_csv
...
def plot_2d(prop1,logger):
    ...
    write_2d_arrays_to_json(y_sat,x_sat,rmse,out_file)

    out_file = os.path.join(prop1.data_skill_2d_json_path, str(prop1.ofs +
                            '_' + prop1.whichcast + '_' + sat_dates[0] +
                            '--' + sat_dates[-1] + '_diffmean_stats.json'))
    write_2d_arrays_to_json(y_sat,x_sat,diff_mean,out_file)

    out_file = os.path.join(prop1.data_skill_2d_json_path, str(prop1.ofs +
                            '_' + prop1.whichcast + '_' + sat_dates[0] +
                            '--' + sat_dates[-1] + '_diffmax_stats.json'))
    write_2d_arrays_to_json(y_sat,x_sat,diff_max,out_file)

    out_file = os.path.join(prop1.data_skill_2d_json_path, str(prop1.ofs +
                            '_' + prop1.whichcast + '_' + sat_dates[0] +
                            '--' + sat_dates[-1] + '_diffstdev_stats.json'))
    write_2d_arrays_to_json(y_sat,x_sat,diff_stdev,out_file)

    out_file = os.path.join(prop1.data_skill_2d_json_path, str(prop1.ofs +
                            '_' + prop1.whichcast + '_' + sat_dates[0] +
                            '--' + sat_dates[-1] + '_cf2d_stats.json'))
    write_2d_arrays_to_json(y_sat,x_sat,cf2d,out_file)

    out_file = os.path.join(prop1.data_skill_2d_json_path, str(prop1.ofs +
                            '_' + prop1.whichcast + '_' + sat_dates[0] +
                            '--' + sat_dates[-1] + '_pof2d_stats.json'))
    write_2d_arrays_to_json(y_sat,x_sat,pof2d,out_file)

    out_file = os.path.join(prop1.data_skill_2d_json_path, str(prop1.ofs +
                            '_' + prop1.whichcast + '_' + sat_dates[0] +
                            '--' + sat_dates[-1] + '_nof2d_stats.json'))
    write_2d_arrays_to_json(y_sat,x_sat,nof2d,out_file)
