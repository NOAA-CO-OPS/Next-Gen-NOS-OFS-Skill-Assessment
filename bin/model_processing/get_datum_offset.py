...
def read_vdatum_from_bucket(prop,logger):
    '''
    Read vertical datum conversion file on-the-fly from the NODD S3 bucket
...
def get_datum_offset(prop, node, model, id_number, logger):
    ...
    if 'stofs' in prop.ofs and prop.datum.lower() == 'xgeoid20b':
        return 0
