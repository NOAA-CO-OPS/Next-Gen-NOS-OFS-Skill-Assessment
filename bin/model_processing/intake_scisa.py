...
Revisions:
    ...
    05/01/2025    AJK                Fix CIOFS issues and optimze fix_roms_uv
                                        function
...
def get_station_dim(engine, urlpaths, drop_variables, logger):
    """
...
def remove_extra_stations(engine,
    urlpaths, dim_ref, drop_variables, time_name,
    logger,
):
    '''
