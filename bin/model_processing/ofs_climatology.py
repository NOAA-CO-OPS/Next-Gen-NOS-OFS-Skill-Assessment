...
# Usage (ofswork): python ofs_climatology.py  -s 2023-01-01T00:00:00Z -e 2024-12-31T23:59:59Z -p /path/to/dbofs/netcdf/ -d /path/to/outdir -o dbofs -m roms -t fields -g all
