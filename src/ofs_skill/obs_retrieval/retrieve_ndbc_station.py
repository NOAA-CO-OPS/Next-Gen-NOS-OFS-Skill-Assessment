    ...
    if data_station.empty is False:
        ...
        if variable == 'water_level':
            if 'TIDE' in data_station.columns:
                if data_station['TIDE'].isna().all() is False:
            ...
            if 'DEP01' in data_station.columns:
                if data_station['DEP01'].isna().all() is False:
                    data_station['DateTime'] = pd.to_datetime(
                        data_station['timestamp'])
                    data_station.loc[
            ...
            if 'OTMP' in data_station.columns:
                if data_station['OTMP'].isna().all() is False:
                    data_station['DateTime'] = pd.to_datetime(
                        data_station['timestamp'])
                    data_station.loc[
                ...
                if data_station['WTMP'].isna().all() is False:
                    data_station['DateTime'] = pd.to_datetime(
                        data_station['timestamp'])
                    data_station.loc[
            ...
            if 'SAL' in data_station.columns:
                if data_station['SAL'].isna().all() is False:
                    data_station['DateTime'] = pd.to_datetime(
                        data_station['timestamp'])
                    data_station.loc[
                        (data_station['SAL'] == 'MM'),
